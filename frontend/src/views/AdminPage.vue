<template>
    <div class="adminpage bg-black mt-5">
        ...
        <div class="col container">
            <h2 class="admin text-white text-center mx-3">User <router-link to="/adminadduser"
                    ...
                    <tr v-for="user in users" :key="user.userID">
                        ...
                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <button class="btn btn-danger btn-block" @click="deleteUser(user.userID)"><i
    ...
    <!-- Products -->
    <div class="col">
        <h2 class="admin text-white text-center mx-5">Product <button @click="showAddItemModal = true"
                class="btn btn-primary mx-3">Add Item</button>
        </h2>
        ...
        <div v-else>
            ...
            <div>
                <table class="table table-striped-columns rounded-5 text-center container">
                    <!-- Table header -->
                    <thead>
                        <tr>
                    ...
                    <tbody v-if="!loadingItems && items">
                        <tr v-for="item in items" :key="item.itemID">
                            ...
                            <td>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <button class="btn btn-primary btn-block" @click="openEditItemModal(item)"> <i
                                                class="bi bi-pencil"></i>
                                        </button>
                                    </div>
                                    <div class="col">
                                        <button class="btn btn-danger deleteButton"
                                            @click="event => deleteItem(item.itemID)"><i
                                                class="bi bi-trash"></i></button>
                                    </div>
                                </div>
                            </td>
